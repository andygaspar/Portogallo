...
class ReplayMemory:
    ...
    def sample(self, sample_size):
        ...
        # print(self.rewards[non_zero_rewards_idx[torch.argsort(non_zero_rewards, dim=0, descending=True)]])
        # print(self.rewards[torch.argsort(non_zero_rewards, dim=0, descending=True)][:(self.current_size-2*self.current_size//3)])
